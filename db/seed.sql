...
INSERT INTO umowa (klient_id, typ_id, przedstawiciel_id, status, data_od, data_do, wartosc_umowy) VALUES
  (1, 1, 1, 'Aktywna', '2026-01-02', '2026-12-31', 0),      -- 1: Ramowa + Aktywna
  (1, 1, 1, 'Zakończona', '2026-01-03', '2026-01-15', 0),   -- 2: Ramowa + Zakończona
  (5, 1, 1, 'Anulowana', '2026-01-04', '2026-06-30', 0),    -- 3: Ramowa + Anulowana
  (4, 1, 1, 'Wstrzymana', '2026-01-05', NULL, 0),           -- 4: Ramowa + Wstrzymana
  (1, 2, 1, 'Aktywna', '2026-01-06', NULL, 0),              -- 5: Jednorazowa + Aktywna
  (1, 2, 1, 'Zakończona', '2026-01-07', NULL, 0),           -- 6: Jednorazowa + Zakończona
  (5, 2, 1, 'Anulowana', '2026-01-08', NULL, 0),            -- 7: Jednorazowa + Anulowana
  (4, 2, 1, 'Wstrzymana', '2026-01-09', NULL, 0);           -- 8: Jednorazowa + Wstrzymana
...
-- === Anna Nowak (ID 2) ===
INSERT INTO umowa (klient_id, typ_id, przedstawiciel_id, status, data_od, data_do, wartosc_umowy) VALUES
  (2, 1, 2, 'Aktywna', '2026-01-10', '2026-12-31', 0),      -- 9: Ramowa + Aktywna
  (2, 1, 2, 'Zakończona', '2026-01-11', '2026-01-20', 0),   -- 10: Ramowa + Zakończona
  (2, 1, 2, 'Anulowana', '2026-01-12', NULL, 0),            -- 11: Ramowa + Anulowana
  (2, 1, 2, 'Wstrzymana', '2026-01-13', NULL, 0),           -- 12: Ramowa + Wstrzymana
  (2, 2, 2, 'Aktywna', '2026-01-14', NULL, 0),              -- 13: Jednorazowa + Aktywna
  (2, 2, 2, 'Zakończona', '2026-01-15', NULL, 0),           -- 14: Jednorazowa + Zakończona
  (2, 2, 2, 'Anulowana', '2026-01-16', NULL, 0),            -- 15: Jednorazowa + Anulowana
  (2, 2, 2, 'Wstrzymana', '2026-01-17', NULL, 0);           -- 16: Jednorazowa + Wstrzymana
...
INSERT INTO umowa (klient_id, typ_id, przedstawiciel_id, status, data_od, data_do, wartosc_umowy) VALUES
  (3, 1, 3, 'Aktywna', '2026-01-18', '2026-12-31', 0),      -- 17: Ramowa + Aktywna
  (3, 1, 3, 'Zakończona', '2026-01-19', '2026-01-25', 0),   -- 18: Ramowa + Zakończona
  (3, 1, 3, 'Anulowana', '2026-01-20', NULL, 0),            -- 19: Ramowa + Anulowana
  (3, 1, 3, 'Wstrzymana', '2026-01-21', NULL, 0),           -- 20: Ramowa + Wstrzymana
  (3, 2, 3, 'Aktywna', '2026-01-22', NULL, 0),              -- 21: Jednorazowa + Aktywna
  (3, 2, 3, 'Zakończona', '2026-01-23', NULL, 0),           -- 22: Jednorazowa + Zakończona
  (3, 2, 3, 'Anulowana', '2026-01-24', NULL, 0),            -- 23: Jednorazowa + Anulowana
  (3, 2, 3, 'Wstrzymana', '2026-01-25', NULL, 0);           -- 24: Jednorazowa + Wstrzymana
...
INSERT INTO umowa (klient_id, typ_id, przedstawiciel_id, status, data_od, data_do, wartosc_umowy) VALUES
  (1, 1, 4, 'Aktywna', '2026-01-26', '2026-12-31', 0),      -- 25: Ramowa + Aktywna
  (4, 1, 4, 'Zakończona', '2026-01-27', '2026-01-30', 0),   -- 26: Ramowa + Zakończona
  (4, 1, 4, 'Anulowana', '2026-01-28', NULL, 0),            -- 27: Ramowa + Anulowana
  (1, 1, 4, 'Wstrzymana', '2026-01-29', NULL, 0),           -- 28: Ramowa + Wstrzymana
  (1, 2, 4, 'Aktywna', '2026-01-30', NULL, 0),              -- 29: Jednorazowa + Aktywna
  (4, 2, 4, 'Zakończona', '2026-01-31', NULL, 0),           -- 30: Jednorazowa + Zakończona
  (1, 2, 4, 'Anulowana', '2026-01-05', NULL, 0),            -- 31: Jednorazowa + Anulowana
  (4, 2, 4, 'Wstrzymana', '2026-01-08', NULL, 0);           -- 32: Jednorazowa + Wstrzymana
...
VALUES
  -- Zrealizowane
  (1, 1, 1, NULL, '2026-01-02 10:00:00', '2026-01-02 10:15:00', 'zrealizowane',
   'Telefon - pierwszy kontakt', 'Klient zainteresowany ofertą ekologicznych warzyw'),
  (1, 1, 2, NULL, '2026-01-03 14:00:00', '2026-01-03 14:30:00', 'zrealizowane',
   'Wizyta w sklepie', 'Omówiono szczegóły współpracy'),
  (1, 1, 3, NULL, '2026-01-04 11:00:00', '2026-01-04 11:10:00', 'zrealizowane',
   'Follow-up po wizycie', 'Umowa podpisana!'),
  (1, 1, 4, 1, '2026-01-05 09:00:00', '2026-01-05 09:05:00', 'zrealizowane',
   'Telefon po dostawie', 'Klient bardzo zadowolony'),
  (5, 1, 5, NULL, '2026-01-06 08:00:00', '2026-01-06 08:00:00', 'zrealizowane',
   'Newsletter miesięczny', 'Wysłano ofertę promocyjną'),
  -- Zaplanowane
  (4, 1, 1, NULL, '2026-01-15 10:00:00', NULL, 'zaplanowane',
   'Telefon do nowego prospektu', 'Znaleziony w spisie firm Bio'),
  (4, 1, 2, NULL, '2026-01-20 14:00:00', NULL, 'zaplanowane',
   'Wizyta zaplanowana', NULL),
  (5, 1, 3, NULL, '2026-01-25 11:00:00', NULL, 'zaplanowane',
   'Follow-up z VIP', 'Sprawdzić decyzję zarządu'),
  -- Odwołane
  (1, 1, 2, NULL, '2026-01-10 10:00:00', NULL, 'odwołane',
...
VALUES
  -- Zrealizowane
  (2, 2, 1, NULL, '2026-01-07 09:00:00', '2026-01-07 09:20:00', 'zrealizowane',
   'Kontakt telefoniczny', 'Kierownik zainteresowany zamówieniem'),
  (2, 2, 2, NULL, '2026-01-08 15:00:00', '2026-01-08 15:45:00', 'zrealizowane',
   'Wizyta w sklepie', 'Ceny konkurencji: kurczak 20 zł/kg'),
  (2, 2, 3, NULL, '2026-01-09 10:00:00', '2026-01-09 10:15:00', 'zrealizowane',
   'Follow-up po wizycie', 'Klient potwierdził zamówienie'),
  (2, 2, 4, 2, '2026-01-10 10:00:00', '2026-01-10 10:08:00', 'zrealizowane',
   'Telefon po dostawie', 'Klient zadowolony'),
  (2, 2, 5, NULL, '2026-01-11 08:00:00', '2026-01-11 08:00:00', 'zrealizowane',
   'Newsletter', 'Wysłano promocje na warzywa'),
  -- Zaplanowane
  (2, 2, 1, NULL, '2026-01-16 09:00:00', NULL, 'zaplanowane',
   'Telefon - nowa oferta', 'Przedstawić nowe produkty'),
  (2, 2, 2, NULL, '2026-01-22 14:00:00', NULL, 'zaplanowane',
   'Wizyta kwartalna', NULL),
  -- Odwołane
  (2, 2, 3, NULL, '2026-01-12 11:00:00', NULL, 'odwołane',
...
VALUES
  -- Zrealizowane
  (3, 3, 1, NULL, '2026-01-13 09:00:00', '2026-01-13 09:15:00', 'zrealizowane',
   'Telefon wstępny', 'Umówiono spotkanie'),
  (3, 3, 2, NULL, '2026-01-14 11:00:00', '2026-01-14 11:30:00', 'zrealizowane',
   'Wizyta w firmie', 'Spotkanie z prezes'),
  (3, 3, 3, NULL, '2026-01-15 14:00:00', '2026-01-15 14:15:00', 'zrealizowane',
   'Follow-up telefoniczny', 'Wysłano ofertę'),
  (3, 3, 4, 3, '2026-01-16 09:00:00', '2026-01-16 09:10:00', 'zrealizowane',
   'Kontrola po dostawie', 'Wszystko OK'),
  (3, 3, 5, NULL, '2026-01-17 08:00:00', '2026-01-17 08:00:00', 'zrealizowane',
   'Newsletter styczniowy', 'Promocja na owoce'),
  -- Zaplanowane
  (3, 3, 2, NULL, '2026-01-23 10:00:00', NULL, 'zaplanowane',
   'Wizyta kontrolna', 'Sprawdzić satysfakcję'),
  (3, 3, 4, 3, '2026-01-28 09:00:00', NULL, 'zaplanowane',
   'Telefon po dostawie', NULL),
  -- Odwołane
  (3, 3, 1, NULL, '2026-01-18 10:00:00', NULL, 'odwołane',
...
VALUES
  -- Zrealizowane
  (1, 4, 1, NULL, '2026-01-19 09:00:00', '2026-01-19 09:20:00', 'zrealizowane',
   'Telefon - nowa oferta', 'Przedstawiono sezonowe produkty'),
  (1, 4, 2, NULL, '2026-01-20 14:00:00', '2026-01-20 14:45:00', 'zrealizowane',
   'Wizyta handlowa', 'Omówiono rozszerzenie współpracy'),
  (1, 4, 3, NULL, '2026-01-21 10:00:00', '2026-01-21 10:10:00', 'zrealizowane',
   'Follow-up', 'Klient potwierdził zwiększenie zamówienia'),
  (1, 4, 4, 1, '2026-01-22 09:00:00', '2026-01-22 09:05:00', 'zrealizowane',
   'Telefon po dostawie', 'Wszystko w porządku'),
  (1, 4, 5, NULL, '2026-01-23 08:00:00', '2026-01-23 08:00:00', 'zrealizowane',
   'Newsletter styczniowy', 'Promocja zimowa'),
  -- Zaplanowane
  (4, 4, 1, NULL, '2026-01-27 10:00:00', NULL, 'zaplanowane',
   'Telefon do prospektu', 'Pierwszy kontakt'),
  (4, 4, 2, NULL, '2026-01-29 11:00:00', NULL, 'zaplanowane',
   'Wizyta prezentacyjna', NULL),
  (1, 4, 5, NULL, '2026-01-31 08:00:00', NULL, 'zaplanowane',
   'Newsletter lutowy', 'Do wysłania'),
  -- Odwołane
  (1, 4, 2, NULL, '2026-01-24 14:00:00', NULL, 'odwołane',
